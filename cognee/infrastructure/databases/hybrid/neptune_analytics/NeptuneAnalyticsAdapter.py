...
class NeptuneAnalyticsAdapter(NeptuneGraphDB, VectorDBInterface):
    ...
    async def embed_data(self, data: list[str]) -> list[list[float]]:
        ...
        prepared_texts = prepare_passage_texts(data)
        return await self.embedding_engine.embed_text(prepared_texts)
    ...
    async def create_data_points(self, collection_name: str, data_points: List[DataPoint]):
        ...
        prepared_texts = prepare_passage_texts(texts)
        data_vectors = await self.embedding_engine.embed_text(prepared_texts)
    ...
    async def search(
        ...
        if query_vector and query_text:
            ...
            data_vectors = await self.embedding_engine.embed_text(prepare_query_texts([query_text]))
    ...
    async def batch_search(
        ...
        prepared_queries = prepare_query_texts(query_texts)
        data_vectors = await self.embedding_engine.embed_text(prepared_queries)
