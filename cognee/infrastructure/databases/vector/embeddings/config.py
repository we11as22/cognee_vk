...
class EmbeddingConfig(BaseSettings):
    ...
    embedding_instruction_mode: str = "off"
    embedding_instruction_default: str = "qa"
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "embedding_instruction_mode": self.embedding_instruction_mode,
            "embedding_instruction_default": self.embedding_instruction_default,
        }
