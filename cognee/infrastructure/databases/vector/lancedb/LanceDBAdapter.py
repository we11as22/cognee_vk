...
from ..embeddings.instruction_manager import (
...
class LanceDBAdapter(VectorDBInterface):
    ...
    async def search(
        ...
        if query_text and not query_vector:
            prepared_query = prepare_query_texts([query_text])[0]
            query_vector = (await self.embedding_engine.embed_text([prepared_query]))[0]
    ...
    async def batch_search(
        ...
        query_vectors = await self.embedding_engine.embed_text(prepared_queries)
